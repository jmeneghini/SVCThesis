...
\ntsetup{school=nova_copy/svc}    % The school id
...
%                               %       ulht/deisi, ulht/mge, other/esep, other/svc
%                               %     ]
...
\ntsetup{abstractorder={en}}   % The order for abstracts for the main language
\ntsetup{abstractorder={en={en}}}   % The order for abstracts for a specific language
